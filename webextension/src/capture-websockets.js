...
},{"./debug":10,"_process":46}],10:[function(require,module,exports){
...
},{"../transport":13,"component-inherit":8,"debug":9,"engine.io-parser":20,"parseqs":28,"xmlhttprequest-ssl":19,"yeast":40}],18:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":13,"component-inherit":8,"debug":9,"engine.io-parser":20,"parseqs":28,"ws":43,"yeast":40}],19:[function(require,module,exports){
(function (global){
...
},{"buffer":44,"isarray":24}],24:[function(require,module,exports){
...
},{"./on":32,"./socket":33,"backo2":3,"component-bind":6,"component-emitter":7,"debug":9,"engine.io-client":11,"indexof":26,"socket.io-parser":36}],32:[function(require,module,exports){
...
},{"./on":32,"component-bind":6,"component-emitter":7,"debug":9,"has-binary2":23,"parseqs":28,"socket.io-parser":36,"to-array":39}],34:[function(require,module,exports){
(function (global){
...
},{"./is-buffer":37,"isarray":38}],36:[function(require,module,exports){
...
},{"./binary":35,"./is-buffer":37,"component-emitter":7,"debug":9,"isarray":38}],37:[function(require,module,exports){
(function (global){
    ...
    if (!vid.paused) {
      ...
      if (numOfBufferedChunks == 10) {
        ...
        for (let i = 0; i < buffersSoFar.getChannelData(0).length; i++) {
          audio.push(buffersSoFar.getChannelData(0)[i]);
        }

        sock.emit("audioprocess", {
          audio: audio,
          sampleRate: buffersSoFar.sampleRate,
          lang: language
        });
...
},{"socket.io-client":30}],42:[function(require,module,exports){
'use strict'
