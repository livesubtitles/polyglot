...
class googleTranscriptionService(object):
    ...
    def _speech_to_text(self, audiobase64, sample_rate, lang, credentials):
    		...
    		if os.environ.get('MODE') != 'paid':
    			json_response = self._send_stt_request(lang, sample_rate, audiobase64)
    		else:
    			json_response = self._send_stt_request_credentials(lang, sample_rate, audiobase64, credentials)
